...
$ADUsers = Get-ADUser -SearchBase $OU.DistinguishedName -Filter * -Properties LastLogOnDate | Where {$_.Enabled -eq $true} | Select-Object -Property Name,Enabled,LastLogOnDate
